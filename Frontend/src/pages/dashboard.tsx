...
export function DashBoard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      {/* Desktop Topbar */}
      <div className="hidden md:flex fixed top-0 left-76 right-0 z-30 h-16 bg-white border-b border-gray-200 items-center justify-between px-6 shadow-sm">
      ...
      {/* Main Content */}
      <main className="px-4 md:pl-80 pt-20 pb-8 transition-all duration-200">
        {view === "qna" ? (
          <QnASection/>
        ) : (
          <>
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center text-purple-500 py-16">
                  ...
                  <p className="text-gray-500 mb-5 text-sm">
                    Start by adding a YouTube, Twitter, Note, or PDF.
                  </p>
                  <Button
                    variant="dark"
                    size="md"
